...
Braintree=(function(){function Stream(enc,pos){if(enc instanceof Stream){this.enc=enc.enc;this.pos=enc.pos;}else{this.enc=enc;this.pos=pos;}}
    ...
    function b64tohex(s){var ret = "";
        var i;var k=0;var slop;
        for(i=0;i<s.length;++i){
            if(s.charAt(i)==b64pad)break;
            var v=b64map.indexOf(s.charAt(i));if(v<0)continue;if(k==0){ret+=int2char(v>>2);slop=v&3;k=1;}
    ...
    (function(){
        try{
            ...
            sjcl.random.addEntropy(ab,1024,"crypto.getRandomValues");}catch(e){}})();for(k in sjcl.beware){if(sjcl.beware.hasOwnProperty(k)){sjcl.beware[k]();}}
